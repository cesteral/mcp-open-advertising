...
| `mcp.execute.meta_entity_update` | `.cursor/skills/meta-entity-manager/SKILL.md` | `.codex/skills/meta-entity-manager/SKILL.md` | Section in `.github/copilot-instructions.md` | `.windsurf/rules/meta-entity-manager.md` | `.clinerules/meta-entity-manager.md` | `.continue/rules/meta-entity-manager.md` | Call prompt `meta_campaign_setup_workflow`, then use CRUD tools |
| `mcp.execute.meta_campaign_setup` | `.cursor/skills/meta-campaign-builder/SKILL.md` | `.codex/skills/meta-campaign-builder/SKILL.md` | Section in `.github/copilot-instructions.md` | `.windsurf/rules/meta-campaign-builder.md` | `.clinerules/meta-campaign-builder.md` | `.continue/rules/meta-campaign-builder.md` | Call prompt `meta_campaign_setup_workflow` directly |
| `mcp.execute.meta_insights` | `.cursor/skills/meta-insights-builder/SKILL.md` | `.codex/skills/meta-insights-builder/SKILL.md` | Section in `.github/copilot-instructions.md` | `.windsurf/rules/meta-insights-builder.md` | `.clinerules/meta-insights-builder.md` | `.continue/rules/meta-insights-builder.md` | Call prompt `meta_insights_reporting_workflow` directly |
| `mcp.execute.meta_bulk_operations` | `.cursor/skills/meta-bulk-operator/SKILL.md` | `.codex/skills/meta-bulk-operator/SKILL.md` | Section in `.github/copilot-instructions.md` | `.windsurf/rules/meta-bulk-operator.md` | `.clinerules/meta-bulk-operator.md` | `.continue/rules/meta-bulk-operator.md` | Use `meta_campaign_setup_workflow` guidance and execute bulk tools |
| `mcp.troubleshoot.meta_entity` | `.cursor/skills/meta-troubleshooter/SKILL.md` | `.codex/skills/meta-troubleshooter/SKILL.md` | Section in `.github/copilot-instructions.md` | `.windsurf/rules/meta-troubleshooter.md` | `.clinerules/meta-troubleshooter.md` | `.continue/rules/meta-troubleshooter.md` | Call prompt `meta_troubleshoot_entity` directly |
