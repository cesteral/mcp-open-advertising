 ...
 * Provides runtime-aware initialization for Node.js environments.
 * Supports GCP Cloud Run/Functions with full NodeSDK integration.
...
function detectCloudResource(): Record<string, string> {
  ...
  // GCP Cloud Functions/Cloud Run detection
  if (
