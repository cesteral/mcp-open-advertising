...
The `services/` directory is designed for external service integrations following a consistent domain-driven pattern. Each service domain provides pluggable providers, allowing you to swap implementations without changing business logic.

**This template currently has all example services removed.** You can add your own services by following the patterns described below.
