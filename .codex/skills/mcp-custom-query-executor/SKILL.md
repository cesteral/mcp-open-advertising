---
name: mcp-custom-query-executor
description: Execute DBM custom query workflow with prompt-guided validation and concise outputs.
---

# MCP Custom Query Executor
