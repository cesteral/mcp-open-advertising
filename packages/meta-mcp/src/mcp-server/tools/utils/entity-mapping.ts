...
const ENTITY_CONFIGS: Record<MetaEntityType, MetaEntityConfig> = {
  campaign: {
    ...
    defaultFields: [
      "id", "name", "status", "configured_status", "objective", "buying_type",
  ...
  adSet: {
    ...
    defaultFields: [
      ...
      "billing_event", "bid_amount", "bid_strategy", "bid_constraints",
      "daily_budget", "lifetime_budget", "budget_remaining",
      "targeting", "frequency_control_specs", "destination_type",
      "promoted_object", "attribution_spec", "pacing_type",
      "is_dynamic_creative", "dsa_beneficiary", "dsa_payor",
  ...
  ad: {
    ...
    defaultFields: [
      ...
      "bid_amount", "tracking_specs", "conversion_domain",
      "preview_shareable_link", "created_time", "updated_time",
    ],
    supportsDuplicate: true,
  },
  adCreative: {
    ...
    defaultFields: [
      ...
      "degrees_of_freedom_spec", "product_set_id", "created_time",
    ],
  },
  customAudience: {
