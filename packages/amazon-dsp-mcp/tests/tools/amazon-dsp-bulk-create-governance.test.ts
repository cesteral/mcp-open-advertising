...
describe("amazon_dsp_bulk_create_entities governance contract (effect class)", () => {
  ...
  it("formatter renders a dry-run message without a false success", () => {
    ...
    expect(content[0].text).toContain("Dry run: bulk-creating 2 order(s) would succeed");
