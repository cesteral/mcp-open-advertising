...
const serverCapabilitiesResource = createServerCapabilitiesResource({
  ...
  toolGroups: {
    ...
    account: ["amazon_dsp_list_profiles"],
    ...
    targeting: ["amazon_dsp_search_targeting", "amazon_dsp_get_targeting_options"],
    specialized: ["amazon_dsp_duplicate_entity", "amazon_dsp_get_audience_estimate", "amazon_dsp_get_ad_preview"],
    validation: ["amazon_dsp_validate_entity"],
  },
  commonWorkflows: ["campaign_setup", "async_reporting", "audience_targeting"],
  startHere: "amazon_dsp_list_profiles",
});
