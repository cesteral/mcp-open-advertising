...
/**
 * Upstream conformance: every fixture in the LinkedIn testkit registry must
 ...
 * (`@cesteral/linkedin-mcp/testkit`) rather than the relative path, to verify
...
import * as publicTestkit from "@cesteral/linkedin-mcp/testkit";

describe("linkedin-mcp testkit conformance", () => {
