...
const TOOL_NAME = "cm360_get_pacing_status";
...
export const GetPacingStatusInputSchema = z
  .object({
    advertiserId: z.string().min(1).describe("CM360 Advertiser ID"),
    campaignId: z.string().min(1).describe("CM360 campaign ID to check pacing for"),
