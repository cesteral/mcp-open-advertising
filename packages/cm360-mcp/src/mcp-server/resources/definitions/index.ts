...
const serverCapabilitiesResource = createServerCapabilitiesResource({
  ...
  toolGroups: {
    crud: ["cm360_list_entities", "cm360_get_entity", "cm360_create_entity", "cm360_update_entity", "cm360_delete_entity"],
    account: ["cm360_list_user_profiles"],
    reporting: ["cm360_get_report", "cm360_submit_report", "cm360_check_report_status", "cm360_download_report"],
