...
export const REGISTRY_DATA: RegistryData = {
  ...
  servers: [
    ...
    },
    {
      ...
      description:
        "Self-hostable DV360 MCP connector for campaign writes, targeting, custom bidding, previews, and media operations",
      runtime_description:
        "Display & Video 360 campaign, line item, creative, and targeting management.",
    ...
    },
    {
      ...
      description:
        "The Trade Desk campaign management and reporting — CRUD, GraphQL, bulk ops, and async reports",
      runtime_description:
        "The Trade Desk REST + GraphQL + Workflows API: campaigns, ad groups, creatives, bid lists, seeds, reporting.",
      platform: "The Trade Desk",
      platform_display_name: "TTD",
      documentation_url: "https://api.thetradedesk.com/v3/portal/api/doc/Welcome",
      auth: {
        modes: ["ttd-token", "jwt", "none"],
      },
    },
    {
      package: "gads-mcp",
      ...
      description:
        "Self-hostable Google Ads MCP connector for campaign writes, GAQL reporting, bulk mutate, validation, and previews",
      runtime_description:
        "Google Ads search, display, and shopping campaign management with GAQL queries.",
      platform: "Google Ads",
      platform_display_name: "Google Ads",
      documentation_url: "https://developers.google.com/google-ads/api",
      auth: {
        modes: ["gads-headers", "jwt", "none"],
      },
    },
    {
      package: "meta-mcp",
      ...
      description:
        "Self-hostable Meta Ads MCP connector for campaign writes, insights, targeting, delivery estimates, previews, and media operations",
      runtime_description:
        "Meta Marketing API: Facebook/Instagram campaigns, ad sets, ads, audiences, insights.",
      platform: "Meta (Facebook/Instagram)",
      platform_display_name: "Meta",
      documentation_url: "https://developers.facebook.com/docs/marketing-apis",
      auth: {
        modes: ["meta-bearer", "jwt", "none"],
      },
    },
    {
      ...
      description:
        "LinkedIn Ads campaign management and analytics — CRUD, targeting, delivery forecasts, and media upload",
      runtime_description:
        "LinkedIn Marketing API: campaigns, creatives, audiences, conversions, analytics.",
      platform: "LinkedIn Ads",
      platform_display_name: "LinkedIn",
      documentation_url: "https://learn.microsoft.com/en-us/linkedin/marketing/",
      auth: {
        modes: ["linkedin-bearer", "jwt", "none"],
      },
    },
    {
      package: "tiktok-mcp",
      ...
      description:
        "TikTok Ads campaign management and reporting — CRUD, async reports, targeting, and media upload",
    ...
    },
    {
      ...
      runtime_description:
        "Campaign Manager 360 ad serving, placements, creatives, and Floodlight tracking.",
    ...
    },
    {
      ...
      description:
        "Snapchat Ads campaign management and reporting — CRUD, async reports, targeting, and audience estimates",
      ...
      auth: {
        modes: ["snapchat-bearer", "jwt", "none"],
      },
    },
    {
      package: "sa360-mcp",
      ...
      description:
        "Search Ads 360 reporting and conversion management — query language, insights, and offline conversions",
    ...
    },
    {
      ...
      description:
        "Pinterest Ads campaign management and reporting — CRUD, async reports, targeting, and audience estimates",
      ...
      auth: {
        modes: ["pinterest-bearer", "jwt", "none"],
      },
    },
    {
      ...
      description:
        "Amazon DSP campaign management and reporting — CRUD, async reports, targeting, and audience management",
      ...
      auth: {
        modes: ["amazon-dsp-bearer", "jwt", "none"],
      },
    },
    {
      package: "msads-mcp",
      ...
      description:
        "Microsoft Advertising campaign management and reporting — CRUD, Google Ads import, ad extensions, and async reports",
      runtime_description:
        "Microsoft Advertising: campaigns, ad groups, ads, keywords, ad extensions, reporting, Google Ads import.",
