...
export class RateLimiter {
   ...
   * @param keyPattern Pattern to match (e.g., "bidmanager:*" for all Bid Manager requests)
   ...
   * @param key Unique identifier for the resource (e.g., "bidmanager:advertiserId")
 ...
 * Configured with default limits for Bid Manager API
 */
export const rateLimiter = new RateLimiter();

// Default configuration: 100 requests per minute per advertiser (Bid Manager API is less restrictive)
