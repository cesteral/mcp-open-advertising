...
describe("pinterest_submit_report governance contract (effect class)", () => {
  ...
  beforeEach(() => {
    ...
    mockResolveSessionServices.mockReturnValue({ pinterestReportingService: svc, boundAdAccountId: "1234567890" });
  });
