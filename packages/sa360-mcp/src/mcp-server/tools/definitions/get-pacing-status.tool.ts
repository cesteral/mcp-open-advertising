...
const TOOL_NAME = "sa360_get_pacing_status";
...
export const GetPacingStatusInputSchema = z
  .object({
    customerId: z.string().min(1).describe("SA360 Customer ID (no dashes)"),
    campaignId: z.string().min(1).describe("SA360 Campaign ID to check pacing for"),
