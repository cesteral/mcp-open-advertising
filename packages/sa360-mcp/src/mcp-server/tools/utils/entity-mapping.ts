...
export type SA360InsightsEntityType =
  | "customer"
  | "campaign"
  | "adGroup"
  | "adGroupAd"
...
const INSIGHTS_ENTITY_CONFIGS: Record<
  SA360InsightsEntityType,
  { queryResource: string; idField: string; nameField: string }
> = {
  customer: {
    queryResource: "customer",
    idField: "customer.id",
  ...
  campaignCriterion: {
    queryResource: "campaign_criterion",
    idField: "campaign_criterion.criterion_id",
    nameField: "campaign_criterion.type",
  },
};
