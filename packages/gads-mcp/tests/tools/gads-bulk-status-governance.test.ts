...
const baseInput = {
  ...
  entityIds: ["9876543210", "1111111111"],
  status: "PAUSED",
};

describe("gads_bulk_update_status governance contract (effect class)", () => {
  ...
  beforeEach(() => {
    ...
    svc = {
      bulkUpdateStatus: vi.fn().mockResolvedValue({
        results: [
          { entityId: "9876543210", success: true },
          { entityId: "1111111111", success: false, error: "x" },
        ],
      }),
    };
