...
/**
 * Upstream conformance: every fixture in the TikTok testkit registry must
 ...
 * (`@cesteral/tiktok-mcp/testkit`) rather than the relative path, to verify
...
import * as publicTestkit from "@cesteral/tiktok-mcp/testkit";

describe("tiktok-mcp testkit conformance", () => {
