...
const TOOL_NAME = "tiktok_get_pacing_status";
...
export const GetPacingStatusInputSchema = z
  .object({
    ...
    campaignId: z.string().min(1).describe("TikTok Campaign ID to check pacing for"),
...
> = {
  ...
  inputExamples: [
    ...
    },
    {
      ...
      input: {
        advertiserId: "6912345678901234567",
        campaignId: "1712345678901234",
        spendToDate: 4200,
        budgetTotal: 10000,
