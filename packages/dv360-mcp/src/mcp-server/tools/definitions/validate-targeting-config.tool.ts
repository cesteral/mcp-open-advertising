...
export async function validateTargetingConfigLogic(
  ...
  const targetingTypes =
    (input.targetingTypesToCheck as TargetingType[]) || DEFAULT_TARGETING_TYPES;
 ...
 */
export function validateTargetingConfigResponseFormatter(
  result: ValidateTargetingConfigOutput
): McpTextContent[] {
