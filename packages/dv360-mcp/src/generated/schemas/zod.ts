 ...
 * Generated at: 2026-06-10T09:49:27.991Z
...
export const InsertionOrder = z.object({
  ...
  insertionOrderType: z
    .enum(["INSERTION_ORDER_TYPE_UNSPECIFIED", "RTB", "OVER_THE_TOP"])
    .optional(),
...
export const BiddingStrategy = z.object({
  ...
  /** A bid strategy used by Demand Gen resources. It can only be used for a Demand Ge */
  demandGenBid: z.lazy(() => DemandGenBiddingStrategy).optional(),
});
...
export const YoutubeAndPartnersBiddingStrategy = z.object({
  ...
  adGroupEffectiveTargetCpaSource: z
    .enum(["BIDDING_SOURCE_UNSPECIFIED", "BIDDING_SOURCE_LINE_ITEM", "BIDDING_SOURCE_AD_GROUP"])
    .optional(),
});
 ...
 */
export const DemandGenBiddingStrategy = z.object({
  /** Optional. The type of the bidding strategy. This can only be set when assigned t */
  type: z
    .enum([
    ...
    .optional(),
  /** Output only. The value effectively used by the bidding strategy. This field will */
  effectiveBiddingValue: z.string().optional(),
  /** Output only. Source of the effective bidding value. */
  effectiveBiddingValueSource: z
    .enum(["BIDDING_SOURCE_UNSPECIFIED", "BIDDING_SOURCE_LINE_ITEM", "BIDDING_SOURCE_AD_GROUP"])
    .optional(),
...
export const LineItem = z.object({
  ...
  /** Optional. Whether to enable DV360's bid optimization for fixed bid line items. B */
  ...
  warningMessages: z
    ...
    .optional(),
  /** Optional. Settings specific to Demand Gen line items. Only applicable to Demand  */
  demandGenSettings: z.lazy(() => DemandGenSettings).optional(),
  /** Optional. Required if the line item type is not `LINE_ITEM_TYPE_DEMAND_GEN`. The */
...
export const VideoAdInventoryControl = z.object({
  ...
  allowNonSkippableInStream: z.boolean().optional(),
 ...
 */
export const DemandGenSettings = z.object({
  /** Optional. The ID of the Merchant Center account used to provide a product feed.  */
  linkedMerchantId: z.string().optional(),
  /** Optional. The third party measurement settings for the Demand Gen line item. */
  thirdPartyMeasurementConfigs: z.lazy(() => ThirdPartyMeasurementConfigs).optional(),
  /** Optional. Immutable. Whether location and language targeting can be set at the l */
  geoLanguageTargetingEnabled: z.boolean().optional(),
});
...
export const LineItemBudget = z.object({
  ...
  budgetUnit: z
    .enum(["BUDGET_UNIT_UNSPECIFIED", "BUDGET_UNIT_CURRENCY", "BUDGET_UNIT_IMPRESSIONS"])
    .optional(),
...
export const TargetingExpansionConfig = z.object({
  ...
  /** Optional. Whether to exclude demographic expansion for Optimized Targeting. This */
  excludeDemographicExpansion: z.boolean().optional(),
  ...
  audienceExpansionLevel: z
    .enum(["UNKNOWN", "NO_REACH", "LEAST_REACH", "MID_REACH", "MOST_REACH"])
    .optional(),
});
...
export const PartnerRevenueModel = z.object({
  /** Required. The markup type of the partner revenue model. This field must be set t */
  markupType: z.enum([
...
export const ConversionCountingConfig = z.object({
  ...
  /** Optional. The attribution model to use for conversion measurement. This attribut */
  primaryAttributionModelId: z.string().optional(),
});
...
export const AdGroup = z.object({
  ...
  /** Optional. The [optimized targeting](//support.google.com/displayvideo/answer/120 */
  targetingExpansion: z.lazy(() => TargetingExpansionConfig).optional(),
  ...
  /** Required. The display name of the ad group. Must be UTF-8 encoded with a maximum */
  displayName: z.string(),
  /** Output only. Identifier. The resource name of the ad group. */
  name: z.string().optional(),
  /** Required. Controls whether or not the ad group can spend its budget and bid on i */
  entityStatus: z.enum([
    "ENTITY_STATUS_UNSPECIFIED",
    "ENTITY_STATUS_ACTIVE",
    "ENTITY_STATUS_ARCHIVED",
  ...
  /** Optional. Required for Demand Gen ad groups. Specifies the inventory control of  */
  adGroupInventoryControl: z.lazy(() => AdGroupInventoryControl).optional(),
  /** Output only. The unique ID of the advertiser the ad group belongs to. */
  advertiserId: z.string().optional(),
  /** Optional. The bidding strategy used by the ad group. Only the youtubeAndPartners */
  bidStrategy: z.lazy(() => BiddingStrategy).optional(),
});
 ...
 */
export const AdGroupInventoryControl = z.object({
  /** The inventory strategy. */
  adGroupInventoryStrategy: z
    .enum([
  ...
  selectedInventories: z.lazy(() => SelectedInventories).optional(),
});

/**
 * The inventory control of the ad group.
 */
export const SelectedInventories = z.object({
...
export const AdGroupAd = z.object({
  ...
  /** Details of a [Demand Gen carousel ad](//support.google.com/displayvideo/answer/1 */
  demandGenCarouselAd: z.lazy(() => DemandGenCarouselAd).optional(),
  /** Output only. Details of an [ad used in a video action campaign](//support.google */
  videoPerformanceAd: z.lazy(() => VideoPerformanceAd).optional(),
  /** Output only. Details of an [ad served on the YouTube Home feed](//support.google */
  ...
  /** Output only. Details of an [ad promoting a video](//support.google.com/displayvi */
  videoDiscoverAd: z.lazy(() => VideoDiscoveryAd).optional(),
  /** Details of a [Demand Gen video ad](//support.google.com/displayvideo/answer/1559 */
  demandGenVideoAd: z.lazy(() => DemandGenVideoAd).optional(),
  /** Required. The display name of the ad. Must be UTF-8 encoded with a maximum size  */
  displayName: z.string(),
  /** Details of a [Demand Gen image ad](//support.google.com/displayvideo/answer/1559 */
  demandGenImageAd: z.lazy(() => DemandGenImageAd).optional(),
  ...
  name: z.string().optional(),
  /** Output only. Details of an [audio ad](//support.google.com/displayvideo/answer/6 */
  audioAd: z.lazy(() => AudioAd).optional(),
  /** Output only. Details of a [non-skippable short in-stream video ad](//support.goo */
  nonSkippableAd: z.lazy(() => NonSkippableAd).optional(),
  /** Output only. Details of a [non-skippable short video ad](//support.google.com/di */
  bumperAd: z.lazy(() => BumperAd).optional(),
  /** Output only. Details of an [in-stream ad skippable after 5 seconds](//support.go */
  inStreamAd: z.lazy(() => InStreamAd).optional(),
  /** Details of a [Demand Gen product ad](//support.google.com/displayvideo/answer/15 */
  demandGenProductAd: z.lazy(() => DemandGenProductAd).optional(),
  /** Required. Immutable. The unique ID of the ad group that the ad belongs to. */
  adGroupId: z.string(),
  /** Optional. The DCM tracking ad info. Only valid for Demand Gen ads. To remove the */
  dcmTrackingInfo: z.lazy(() => DcmTrackingInfo).optional(),
});
 ...
 */
export const DemandGenCarouselAd = z.object({
  /** Optional. The suffix to append to landing page URLs. */
  finalUrlSuffix: z.string().optional(),
  /** Required. The URL address of the webpage that people reach after they click the  */
  finalUrl: z.string(),
  ...
  userSpecifiedTrackingUrl: z.string().optional(),
  /** Required. The logo image used by this ad. */
  logo: z.lazy(() => ImageAsset),
  /** Required. The business name shown on the ad. */
  businessName: z.string(),
  /** Required. The list of cards shown on the ad. */
  cards: z.array(z.lazy(() => CarouselCard)),
  /** Optional. The custom parameters and accompanying values to add to the tracking U */
 ...
 */
export const CarouselCard = z.object({
  /** Required. The URL address of the webpage that people reach after they click the  */
  finalUrl: z.string(),
  /** Optional. The portrait marketing image shown on the card. */
  portraitMarketingImage: z.lazy(() => ImageAsset).optional(),
  /** Optional. The marketing image shown on the card. */
  marketingImage: z.lazy(() => ImageAsset).optional(),
  /** Required. The headline of the card. */
  headline: z.string(),
  /** Optional. The URL address of the webpage that people reach after they click the  */
  finalMobileUrl: z.string().optional(),
  /** Required. The text on the call-to-action button shown on the card. Must use 10 c */
  callToAction: z.string(),
  /** Optional. The square marketing image shown on the card. */
  squareMarketingImage: z.lazy(() => ImageAsset).optional(),
});
...
export const YoutubeVideoDetails = z.object({
  /** Required. The YouTube video asset id. This is the adAssetId of an AdAsset resour */
 ...
 */
export const DemandGenVideoAd = z.object({
  /** Required. The URL address of the webpage that people reach after they click the  */
  finalUrl: z.string(),
  /** Required. The list of YouTube video assets used by this ad. */
  videos: z.array(z.lazy(() => YoutubeVideoDetails)),
  /** Output only. The URL address loaded in the background for tracking purposes. */
  trackingUrl: z.string().optional(),
  /** Optional. The tracking URL specified by the user manually. */
  userSpecifiedTrackingUrl: z.string().optional(),
 ...
 */
export const DemandGenImageAd = z.object({
  /** The list of square marketing images shown on the ad. */
  squareMarketingImages: z.array(z.lazy(() => ImageAsset)).optional(),
  /** The list of portrait marketing images shown on the ad. */
  portraitMarketingImages: z.array(z.lazy(() => ImageAsset)).optional(),
  /** Required. The list of headlines shown on the ad. */
  headlines: z.array(z.string()),
  /** Required. The business name shown on the ad. */
  businessName: z.string(),
  /** The list of logo images shown on the ad. */
  logoImages: z.array(z.lazy(() => ImageAsset)).optional(),
  /** Output only. The URL address loaded in the background for tracking purposes. */
  trackingUrl: z.string().optional(),
  /** Optional. The tracking URL specified by the user manually. */
  userSpecifiedTrackingUrl: z.string().optional(),
  ...
  marketingImages: z.array(z.lazy(() => ImageAsset)).optional(),
  /** Required. The URL address of the webpage that people reach after they click the  */
  finalUrl: z.string(),
  /** Optional. The URL address of the webpage that people reach after they click the  */
  finalMobileUrl: z.string().optional(),
...
export const AdPolicyTopicEntry = z.object({
  ...
  policyDecisionType: z
    .enum(["AD_POLICY_DECISION_TYPE_UNKNOWN", "PURSUANT_TO_NOTICE", "GOOGLE_INVESTIGATION"])
    .optional(),
  ...
  policyEnforcementMeans: z
    .enum(["AD_POLICY_ENFORCEMENT_MEANS_UNKNOWN", "AUTOMATED", "HUMAN_REVIEW"])
    .optional(),
});
...
export const AdPolicyTopicAppealInfo = z.object({
  ...
  appealType: z
    .enum(["AD_POLICY_APPEAL_TYPE_UNKNOWN", "SELF_SERVICE_APPEAL", "APPEAL_FORM"])
    .optional(),
...
export const AdPolicyTopicEvidenceRegionalRequirements = z.object({
  ...
  regionalRequirementsEntries: z
    .array(z.lazy(() => AdPolicyTopicEvidenceRegionalRequirementsRegionalRequirementsEntry))
    .optional(),
});
...
export const AdPolicyTopicConstraint = z.object({
  ...
  certificateMissingCountryList: z
    .lazy(() => AdPolicyTopicConstraintAdPolicyCountryConstraintList)
    .optional(),
  /** Reseller constraint. */
  ...
  globalCertificateMissing: z
    .lazy(() => AdPolicyTopicConstraintAdPolicyGlobalCertificateMissingConstraint)
    .optional(),
  /** Countries where the resource's domain is not covered by the certificates associa */
  certificateDomainMismatchCountryList: z
    .lazy(() => AdPolicyTopicConstraintAdPolicyCountryConstraintList)
    .optional(),
  /** Certificate is required to serve in any country and the existing certificate doe */
  globalCertificateDomainMismatch: z
    .lazy(() => AdPolicyTopicConstraintAdPolicyGlobalCertificateDomainMismatchConstraint)
    .optional(),
 ...
 */
export const DemandGenProductAd = z.object({
  /** Required. The URL address of the webpage that people reach after they click the  */
  finalUrl: z.string(),
  /** Required. The description of the ad. */
  description: z.string(),
 ...
 */
export const DcmTrackingInfo = z.object({
...
export const ReviewStatusInfo = z.object({
  ...
  creativeAndLandingPageReviewStatus: z
    .enum([
  ...
  contentAndPolicyReviewStatus: z
    .enum([
      "REVIEW_STATUS_UNSPECIFIED",
      "REVIEW_STATUS_APPROVED",
      "REVIEW_STATUS_REJECTED",
...
export const AssignedTargetingOption = z.object({
  ...
  digitalContentLabelExclusionDetails: z
    .lazy(() => DigitalContentLabelAssignedTargetingOptionDetails)
    .optional(),
  /** Proximity location list details. This field will be populated when the targeting */
  proximityLocationListDetails: z
    .lazy(() => ProximityLocationListAssignedTargetingOptionDetails)
    .optional(),
  /** User rewarded content details. This field will be populated when the targeting_t */
  userRewardedContentDetails: z
    .lazy(() => UserRewardedContentAssignedTargetingOptionDetails)
    .optional(),
  ...
  /** YouTube channel pack details. This field will be populated when the targeting_ty */
  youtubeChannelPackDetails: z
    .lazy(() => YoutubeChannelPackAssignedTargetingOptionDetails)
    .optional(),
  ...
  contentInstreamPositionDetails: z
    .lazy(() => ContentInstreamPositionAssignedTargetingOptionDetails)
    .optional(),
  /** Regional location list details. This field will be populated when the targeting_ */
  regionalLocationListDetails: z
    .lazy(() => RegionalLocationListAssignedTargetingOptionDetails)
    .optional(),
  ...
  sensitiveCategoryExclusionDetails: z
    .lazy(() => SensitiveCategoryAssignedTargetingOptionDetails)
    .optional(),
  /** Content outstream position details. This field will be populated when the target */
  contentOutstreamPositionDetails: z
    .lazy(() => ContentOutstreamPositionAssignedTargetingOptionDetails)
    .optional(),
  /** Native content position details. This field will be populated when the targeting */
  nativeContentPositionDetails: z
    .lazy(() => NativeContentPositionAssignedTargetingOptionDetails)
    .optional(),
  ...
  contentStreamTypeDetails: z
    .lazy(() => ContentStreamTypeAssignedTargetingOptionDetails)
    .optional(),
  ...
  inventorySourceGroupDetails: z
    .lazy(() => InventorySourceGroupAssignedTargetingOptionDetails)
    .optional(),
  ...
  authorizedSellerStatusDetails: z
    .lazy(() => AuthorizedSellerStatusAssignedTargetingOptionDetails)
    .optional(),
  ...
  targetingType: z
    ...
    .optional(),
  /** Keyword details. This field will be populated when the targeting_type is `TARGET */
  negativeKeywordListDetails: z
    .lazy(() => NegativeKeywordListAssignedTargetingOptionDetails)
    .optional(),
  /** Third party verification details. This field will be populated when the targetin */
  thirdPartyVerifierDetails: z
    .lazy(() => ThirdPartyVerifierAssignedTargetingOptionDetails)
    .optional(),
...
export const AudienceGroupAssignedTargetingOptionDetails = z.object({
  ...
  excludedFirstPartyAndPartnerAudienceGroup: z
    .lazy(() => FirstPartyAndPartnerAudienceGroup)
    .optional(),
  ...
  includedFirstPartyAndPartnerAudienceGroups: z
    .array(z.lazy(() => FirstPartyAndPartnerAudienceGroup))
    .optional(),
});
 ...
 */
export const YoutubeChannelPackAssignedTargetingOptionDetails = z.object({
...
export const ContentInstreamPositionAssignedTargetingOptionDetails = z.object({
  ...
  adType: z
    .enum(["AD_TYPE_UNSPECIFIED", "AD_TYPE_DISPLAY", "AD_TYPE_VIDEO", "AD_TYPE_AUDIO"])
    .optional(),
});
...
export const ContentStreamTypeAssignedTargetingOptionDetails = z.object({
  ...
  contentStreamType: z
    .enum(["CONTENT_STREAM_TYPE_UNSPECIFIED", "CONTENT_LIVE_STREAM", "CONTENT_ON_DEMAND"])
    .optional(),
});
...
export const KeywordAssignedTargetingOptionDetails = z.object({
  ...
  /** Indicates if this option is being negatively targeted. */
  negative: z.boolean().optional(),
  /** Optional. The policy names to exempt the keyword from. When attempting to target */
  exemptedPolicyNames: z.array(z.string()).optional(),
});
...
export const IntegralAdScience = z.object({
  ...
  excludedIllegalDownloadsRisk: z
    .enum(["ILLEGAL_DOWNLOADS_UNSPECIFIED", "ILLEGAL_DOWNLOADS_HR", "ILLEGAL_DOWNLOADS_HMR"])
    .optional(),
  /** Brand Safety - **Hate speech**. */
  excludedHateSpeechRisk: z
    .enum(["HATE_SPEECH_UNSPECIFIED", "HATE_SPEECH_HR", "HATE_SPEECH_HMR"])
    .optional(),
  ...
  excludedOffensiveLanguageRisk: z
    .enum(["OFFENSIVE_LANGUAGE_UNSPECIFIED", "OFFENSIVE_LANGUAGE_HR", "OFFENSIVE_LANGUAGE_HMR"])
    .optional(),
  /** Display Viewability section (applicable to display line items only). */
  displayViewability: z
    .enum([
...
export const Adloox = z.object({
  ...
  hateSpeechActsAggressionContent: z
    .enum([
      "GARM_RISK_EXCLUSION_UNSPECIFIED",
      "GARM_RISK_EXCLUSION_FLOOR",
      "GARM_RISK_EXCLUSION_HIGH",
  ...
  debatedSensitiveSocialIssueContent: z
    .enum([
      "GARM_RISK_EXCLUSION_UNSPECIFIED",
      "GARM_RISK_EXCLUSION_FLOOR",
      "GARM_RISK_EXCLUSION_HIGH",
  ...
  deathInjuryMilitaryConflictContent: z
    .enum([
      "GARM_RISK_EXCLUSION_UNSPECIFIED",
      "GARM_RISK_EXCLUSION_FLOOR",
      "GARM_RISK_EXCLUSION_HIGH",
  ...
  illegalDrugsTobaccoEcigarettesVapingAlcoholContent: z
    .enum([
      "GARM_RISK_EXCLUSION_UNSPECIFIED",
      "GARM_RISK_EXCLUSION_FLOOR",
      "GARM_RISK_EXCLUSION_HIGH",
  ...
  excludedFraudIvtMfaCategories: z
    .array(z.enum(["FRAUD_IVT_MFA_CATEGORY_UNSPECIFIED", "FRAUD_IVT_MFA"]))
    .optional(),
});
...
export const DoubleVerifyBrandSafetyCategories = z.object({
  ...
  avoidedHighSeverityCategories: z
    .array(
      z.enum([
  ...
  avoidedMediumSeverityCategories: z
    .array(
      z.enum([
...
export const SessionPositionAssignedTargetingOptionDetails = z.object({
  ...
  sessionPosition: z
    .enum(["SESSION_POSITION_UNSPECIFIED", "SESSION_POSITION_FIRST_IMPRESSION"])
    .optional(),
});
