 ...
 * Generated at: 2026-07-25T21:47:03.227Z
...
export const Advertiser = z.object({
  ...
  /** Optional. The default business name for the advertiser. This is the value used b */
  ...
  updateTime: z.string().optional(),
  /** Optional. The asset ID of the default logo image for the advertiser. This is the */
...
export const DemandGenBiddingStrategy = z.object({
  ...
  type: z.enum(["DEMAND_GEN_BIDDING_STRATEGY_TYPE_UNSPECIFIED", "DEMAND_GEN_BIDDING_STRATEGY_TYPE_TARGET_CPA", "DEMAND_GEN_BIDDING_STRATEGY_TYPE_TARGET_ROAS", "DEMAND_GEN_BIDDING_STRATEGY_TYPE_MAXIMIZE_CONVERSIONS", "DEMAND_GEN_BIDDING_STRATEGY_TYPE_MAXIMIZE_CONVERSION_VALUE", "DEMAND_GEN_BIDDING_STRATEGY_TYPE_MAXIMIZE_CLICKS", "DEMAND_GEN_BIDDING_STRATEGY_TYPE_TARGET_CPC"]).optional(),
  /** Output only. Source of the effective bidding value. */
  effectiveBiddingValueSource: z.enum(["BIDDING_SOURCE_UNSPECIFIED", "BIDDING_SOURCE_LINE_ITEM", "BIDDING_SOURCE_AD_GROUP"]).optional(),
});
...
export const ThirdPartyVendorConfig = z.object({
  ...
  vendor: z.enum(["THIRD_PARTY_VENDOR_UNSPECIFIED", "THIRD_PARTY_VENDOR_MOAT", "THIRD_PARTY_VENDOR_DOUBLE_VERIFY", "THIRD_PARTY_VENDOR_INTEGRAL_AD_SCIENCE", "THIRD_PARTY_VENDOR_COMSCORE", "THIRD_PARTY_VENDOR_TELEMETRY", "THIRD_PARTY_VENDOR_MEETRICS", "THIRD_PARTY_VENDOR_ZEFR", "THIRD_PARTY_VENDOR_NIELSEN", "THIRD_PARTY_VENDOR_KANTAR", "THIRD_PARTY_VENDOR_DYNATA", "THIRD_PARTY_VENDOR_TRANSUNION", "THIRD_PARTY_VENDOR_ORIGIN", "THIRD_PARTY_VENDOR_GEMIUS", "THIRD_PARTY_VENDOR_MEDIA_SCOPE", "THIRD_PARTY_VENDOR_AUDIENCE_PROJECT", "THIRD_PARTY_VENDOR_VIDEO_AMP", "THIRD_PARTY_VENDOR_ISPOT_TV", "THIRD_PARTY_VENDOR_INTAGE", "THIRD_PARTY_VENDOR_MACROMILL", "THIRD_PARTY_VENDOR_VIDEO_RESEARCH"]).optional(),
});
...
export const AdGroup = z.object({
  ...
  adGroupFormat: z.enum(["AD_GROUP_FORMAT_UNSPECIFIED", "AD_GROUP_FORMAT_IN_STREAM", "AD_GROUP_FORMAT_VIDEO_DISCOVERY", "AD_GROUP_FORMAT_BUMPER", "AD_GROUP_FORMAT_NON_SKIPPABLE_IN_STREAM", "AD_GROUP_FORMAT_AUDIO", "AD_GROUP_FORMAT_RESPONSIVE", "AD_GROUP_FORMAT_REACH", "AD_GROUP_FORMAT_MASTHEAD", "AD_GROUP_FORMAT_DEMAND_GEN"]),
});
...
export const AdGroupInventoryControl = z.object({
  ...
  adGroupInventoryStrategy: z.enum(["AD_GROUP_INVENTORY_STRATEGY_UNSPECIFIED", "AD_GROUP_INVENTORY_STRATEGY_ALL_GOOGLE_AND_DISPLAY_NETWORK_INVENTORY", "AD_GROUP_INVENTORY_STRATEGY_ALL_GOOGLE_INVENTORY"]).optional(),
...
export const DemandGenCarouselAd = z.object({
  ...
  finalUrl: z.string(),
  /** Optional. The logo image used by this ad. This setting is required unless a defa */
  logo: z.lazy(() => ImageAsset).optional(),
  ...
  trackingUrl: z.string().optional(),
  /** Optional. The business name shown on the ad. This setting is required unless a d */
...
export const DemandGenProductAd = z.object({
  ...
  callToAction: z.enum(["CALL_TO_ACTION_UNSPECIFIED", "AUTOMATED", "LEARN_MORE", "GET_QUOTE", "APPLY_NOW", "SIGN_UP", "CONTACT_US", "SUBSCRIBE", "DOWNLOAD", "BOOK_NOW", "SHOP_NOW", "BUY_NOW", "DONATE_NOW", "ORDER_NOW", "PLAY_NOW", "SEE_MORE", "START_NOW", "VISIT_SITE", "WATCH_NOW"]),
  /** Optional. The custom parameters and accompanying values to add to the tracking U */
  customParameters: z.record(z.string()).optional(),
  /** Required. The headline of the ad. */
  headline: z.string(),
...
export const DemandGenImageAd = z.object({
  ...
  /** Optional. The business name shown on the ad. This setting is required unless a d */
  businessName: z.string().optional(),
  /** The list of logo images shown on the ad. This setting is required unless a defau */
...
export const Creative = z.object({
  ...
  /** Optional. Whether the creative contains synthetic content or was created using A */
  syntheticContentAttestationStatus: z.enum(["SYNTHETIC_CONTENT_ATTESTATION_STATUS_UNSPECIFIED", "NOT_SYNTHETIC", "IS_SYNTHETIC"]).optional(),
...
export const AssignedTargetingOption = z.object({
  ...
  youtubeChannelPackDetails: z.lazy(() => YoutubeChannelPackAssignedTargetingOptionDetails).optional(),
...
export const AudioContentTypeAssignedTargetingOptionDetails = z.object({
  ...
  audioContentType: z.enum(["AUDIO_CONTENT_TYPE_UNSPECIFIED", "AUDIO_CONTENT_TYPE_UNKNOWN", "AUDIO_CONTENT_TYPE_MUSIC", "AUDIO_CONTENT_TYPE_BROADCAST", "AUDIO_CONTENT_TYPE_PODCAST", "AUDIO_CONTENT_TYPE_CATCH_UP_RADIO", "AUDIO_CONTENT_TYPE_WEB_RADIO", "AUDIO_CONTENT_TYPE_VIDEO_GAME", "AUDIO_CONTENT_TYPE_TEXT_TO_SPEECH"]),
});
