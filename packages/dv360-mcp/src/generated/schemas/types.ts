...
export interface components {
  schemas: {
    ...
    LineItem: {
      ...
      /** @description Optional. Settings specific to Demand Gen line items. Only applicable to Demand Gen line items. Retrieval and management of Demand Gen resources is currently in beta. This field will begin rolling out to all partners on *June 10, 2026* and be available to all partners on *June 24, 2026*. */
    ...
    AdGroupAd: {
      ...
      /** @description Details of a [Demand Gen carousel ad](//support.google.com/displayvideo/answer/15598924?&sjid=11207068802760924844-NC#CarouselAd). Retrieval and management of Demand Gen resources is currently in beta. This field will begin rolling out to all partners on *June 10, 2026* and be available to all partners on *June 24, 2026*. */
      ...
      /** @description Details of a [Demand Gen video ad](//support.google.com/displayvideo/answer/15598924?&sjid=11207068802760924844-NC#VideoAd). Retrieval and management of Demand Gen resources is currently in beta. This field will begin rolling out to all partners on *June 10, 2026* and be available to all partners on *June 24, 2026*. */
      ...
      displayName: string;
      /** @description Details of a [Demand Gen image ad](//support.google.com/displayvideo/answer/15598924?&sjid=11207068802760924844-NC#ImageAd). Retrieval and management of Demand Gen resources is currently in beta. This field will begin rolling out to all partners on *June 10, 2026* and be available to all partners on *June 24, 2026*. */
    ...
    DemandGenCarouselAd: {
      ...
      /** @description Required. The logo image used by this ad. */
      logo: components["schemas"]["ImageAsset"];
      /** @description Required. The business name shown on the ad. */
      businessName: string;
    ...
    DemandGenImageAd: {
      ...
      /** @description Required. The business name shown on the ad. */
      businessName: string;
      /** @description The list of logo images shown on the ad. */
