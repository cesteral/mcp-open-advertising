 ...
 *
 * 25 tools total:
 *   6 core: list entities, get entity, create entity, update entity, delete entity, duplicate entity
 ...
 *   1 discovery: snapchat_search_tools (generated by createToolSearchTool)
 */
