...
export const UploadImageOutputSchema = z
  .object({
    mediaId: z
      ...
      .optional()
      .describe(
        "Media ID for use in creative payloads. Absent on a dry_run (nothing was uploaded)."
      ),
...
export const uploadImageTool = {
  ...
  annotations: {
    ...
    cesteral: {
      ...
      entityIdArgs: [],
      schemaVersion: 1,
      contractId: "snapchat.upload_image.v1",
      // `dry_run` = symbolic validate + symbolic effect projection. Snapchat has no
