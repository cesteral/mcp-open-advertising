...
export const campaignSetupWorkflowPrompt: Prompt = {
  ...
  description: "Step-by-step guide for creating a complete Snapchat Ads campaign structure (Campaign > Ad Group > Ad)",
  arguments: [
    {
      name: "adAccountId",
      description: "Snapchat Advertiser ID (e.g., 1234567890)",
      required: true,
    },
    {
      name: "objective",
...
3. Activate: \`snapchat_bulk_update_status\` with operationStatus: "ENABLE"
...
- ⚠️ Video IDs must be uploaded to Snapchat Creative Library first
- ⚠️ Budget values are in account currency (NOT cents)
- ⚠️ All status updates use separate /status/update/ endpoints — use \`snapchat_bulk_update_status\`
