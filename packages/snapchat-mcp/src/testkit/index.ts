...
/**
 * `@cesteral/snapchat-mcp/testkit` — public testing surface for downstream
 * consumers (notably `cesteral-intelligence`'s preview test suite) and
 * upstream conformance tests.
 *
 * Exports:
 * - `SnapchatWriteFixture` and related types
 ...
 * - `applySnapchatPatch` — re-exported from the tool's symbolic-apply helper
 *   so consumers can wire their own assertions
 */

import { applySnapchatPatch } from "../mcp-server/tools/utils/dry-run.js";
import type { SnapchatEntityKindKey, SnapchatOperation, SnapchatWriteFixture } from "./types.js";
import { allFixtures } from "./fixtures/index.js";

export type {
  SnapchatEntityKindKey,
  SnapchatFixtureArgs,
  SnapchatOperation,
  SnapchatWriteFixture,
} from "./types.js";

export { applySnapchatPatch } from "../mcp-server/tools/utils/dry-run.js";
