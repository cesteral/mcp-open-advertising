...
/**
 * Upstream conformance: every fixture in the Snapchat testkit registry must
 ...
 * (`@cesteral/snapchat-mcp/testkit`) rather than the relative path, to
...
import * as publicTestkit from "@cesteral/snapchat-mcp/testkit";

describe("snapchat-mcp testkit conformance", () => {
