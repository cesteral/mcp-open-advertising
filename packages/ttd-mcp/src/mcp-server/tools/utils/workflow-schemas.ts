...
export const RestRequestInputSchema = z.object({
  methodType: RestMethodTypeSchema.describe("HTTP method to execute through the TTD Workflows REST passthrough"),
  endpoint: z
    .string()
    .min(1)
    .nullable()
...
export const FirstPartyDataJobInputSchema = z.object({
  ...
  nameFilter: z.string().nullable().optional().describe("Optional name filter applied to first-party data results"),
  queryShape: z.string().nullable().optional().describe("Optional GraphQL-style query shape for the returned result fields"),
  callbackInput: WorkflowCallbackInputSchema.optional().describe("Optional webhook callback for async completion"),
});
...
export const CampaignWorkflowPrimaryInputSchema = z.object({
...
export const CampaignCreateWorkflowInputSchema = z.object({
  ...
  adGroups: z.array(LooseObjectSchema).nullable().optional().describe("Optional ad groups to create along with the campaign"),
  validateInputOnly: z.boolean().nullable().optional().describe("When true, TTD validates the payload without persisting it"),
});
...
export const AdGroupWorkflowPrimaryInputSchema = z.object({
...
export const CampaignsJobInputSchema = z.object({
  input: z.array(CampaignCreateWorkflowInputSchema).nullable().describe("Campaign workflow items to create"),
  validateInputOnly: z.boolean().nullable().optional().describe("When true, TTD validates the payload without persisting it"),
  callbackInput: WorkflowCallbackInputSchema.optional().describe("Optional webhook callback for async completion"),
});

export const CampaignsUpdateJobInputSchema = z.object({
  input: z.array(CampaignUpdateWorkflowInputSchema).nullable().describe("Campaign workflow items to update"),
  validateInputOnly: z.boolean().nullable().optional().describe("When true, TTD validates the payload without persisting it"),
  callbackInput: WorkflowCallbackInputSchema.optional().describe("Optional webhook callback for async completion"),
});

export const AdGroupsJobInputSchema = z.object({
  input: z.array(AdGroupCreateWorkflowInputSchema).nullable().describe("Ad group workflow items to create"),
  validateInputOnly: z.boolean().nullable().optional().describe("When true, TTD validates the payload without persisting it"),
  callbackInput: WorkflowCallbackInputSchema.optional().describe("Optional webhook callback for async completion"),
});

export const AdGroupsUpdateJobInputSchema = z.object({
  input: z.array(AdGroupUpdateWorkflowInputSchema).nullable().describe("Ad group workflow items to update"),
  validateInputOnly: z.boolean().nullable().optional().describe("When true, TTD validates the payload without persisting it"),
  callbackInput: WorkflowCallbackInputSchema.optional().describe("Optional webhook callback for async completion"),
});
