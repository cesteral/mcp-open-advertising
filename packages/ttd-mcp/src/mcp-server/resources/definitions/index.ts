...
const serverCapabilitiesResource = createServerCapabilitiesResource({
  ...
  toolGroups: {
    ...
    campaignWorkflows: [
      "ttd_create_campaign_workflow",
      "ttd_update_campaign_workflow",
      "ttd_create_campaigns_job",
      "ttd_update_campaigns_job",
      "ttd_create_ad_group_workflow",
      "ttd_update_ad_group_workflow",
      "ttd_create_ad_groups_job",
      "ttd_update_ad_groups_job",
      "ttd_get_job_status",
