...
echo "  - @cesteral/cm360-mcp"
echo "  - @cesteral/sa360-mcp"
echo "  - @cesteral/pinterest-mcp"
echo "  - @cesteral/snapchat-mcp"
echo "  - @cesteral/amazon-dsp-mcp"
echo "  - @cesteral/msads-mcp"
